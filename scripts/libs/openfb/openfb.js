...
var openFB = (function () {
	...
	if (location.protocol=='file:') var oauthRedirectURL = 'http://rneitzel.appinaut.de/oauthcallback.html';
	else var oauthRedirectURL = baseURL + '/oauthcallback.html';
	if (location.protocol=='file:') var logoutRedirectURL = baseURL + 'http://rneitzel.appinaut.de/logoutcallback.html';
	else var logoutRedirectURL = baseURL + '/logoutcallback.html';
	/*
	...
	*/
    ...
    if (window.runningInCordova == true) {
		alert('window.runningInCordova');
    }
