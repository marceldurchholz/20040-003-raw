 ...
 */
	...
	function checkCurrencyFormat(format) {
		var defaults = accounting.settings.currency.format;
	 ...
	 */
	var unformat = accounting.unformat = accounting.parse = function(value, decimal) {
	 ...
	 */
	var toFixed = accounting.toFixed = function(value, precision) {
	 ...
	 */
	var formatNumber = accounting.formatNumber = accounting.format = function(number, precision, thousand, decimal) {
	 ...
	 */
	var formatMoney = accounting.formatMoney = function(number, symbol, precision, thousand, decimal, format) {
		// Resursively format arrays:
		if (isArray(number)) {
			return map(number, function(val){
